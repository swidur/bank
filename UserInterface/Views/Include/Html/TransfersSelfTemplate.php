                    ...
                    <div class="container col-xl-8 col-lg-8">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Nowy przelew na rachunek własny</h6>
                            </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="card-body">
                                        <div class="container">
                                            ...
                                            <form class="transfer" action="/gr4/dashboard/selfTransfer" method="POST">

                                                <h1 class="h5 mb-0 text-dark my-1">Konto źrodłowe</h1>
                                                <div class="form-group row ">
                                                    <div class="container">
                                                        <select class="browser-default custom-select" id="fromAccount"
                                                                name="fromAccount">
                                                ...
                                                <h1 class="h5 mb-0 text-dark my-1">Konto docelowe:</h1>
                                                ...
                                                <div class="form-group row ">
                                                    <div class="container">
                                                        <select class="browser-default custom-select" id="fromAccount"
                                                                name="fromAccount">
                                                            <option selected disabled>Na rachunek:</option>
                                                            <option value="1">One - saldo</option>
                                                            <option value="2">Two - saldo</option>
                                                            <option value="3">Three- saldo</option>
                                                        </select>
                                                ...
                                                <div class="container">
                                                    <textarea maxlength="140" minlength="1" class="form-control"
                                                              id="recipientAddress" placeholder="Tytułem"
                                                              rows="2"></textarea>
                                                </div>
                                        </div>
                                        <div class="form-group row ">
                                            <div class="container">
                                                <input type="date" id="sendDate" class="form-control form-control-user"
                                                       name="sendDate" placeholder="Data wykonania" value=""
                                                       autocomplete="off">
                                            </div>
                                        </div>

                                        <button class="btn btn-primary btn-user btn-block" type="submit"
                                                name="transferConfirm">Zatwierdź
                                        </button>
                                        </form>
                                    </div>
                                </div>
