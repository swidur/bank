...
<head>
    ...
    <title>Brilliant Bank - Strona główna</title>
    ...
    <link href="./UserInterface/Views/Include/Css/Homepage.css" rel="stylesheet">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active"
                     style="background-image: url('Media/Images/slide1_1920x1080.jpg'); background-position: center" ;>
                    <div class="carousel-caption d-none d-md-block">
                        <h3 class="text-sh-sm">Brilliant Bank</h3>
                        <p class="text-sh-sm">Niektórzy nasi pracownicy noszą garnitury!</p>
                    </div>
                </div>
                <!-- Slide Two - Set the background image for this slide in the line below -->
                <div class="carousel-item"
                     style="background-image: url('Media/Images/slide2_1920x1080.jpg'); background-position: bottom">
                    <div class="carousel-caption d-none d-md-block">
                        <h3 class="text-sh-sm">Planujesz kupić dom?</h3>
                        <p class="text-sh-sm">Powodzenia.</p>
                    </div>
                </div>
                <!-- Slide Three - Set the background image for this slide in the line below -->
                <div class="carousel-item"
                     style="background-image: url('Media/Images/slide3_1920x1080.jpg'); background-position: top">
                    <div class="carousel-caption d-none d-md-block">
                        <h3 class="text-sh-sm">Płacenie kartą przez internet?</h3>
                        <p class="text-sh-sm">A komu to potrzebne? A dlaczego?</p>
                    </div>
                </div>
            </div>
...
<div class="container">
    ...
    <h1 class="my-4">Witaj w Brilliant Bank</h1>
