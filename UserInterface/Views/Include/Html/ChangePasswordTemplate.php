                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Wprowadź nowe hasło</h1>
                                </div>
                                <form class="user" action="/gr4/changePassword" name="login" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user"
                                               name="confirmPassword" autocomplete="off" placeholder="Powtórz hasło">
                                    </div>
                                    <div class="form-group">
                                    </div>
                                    <button class="btn btn-primary btn-user btn-block" type="submit"
                                            name="changePasswordSubmit">Zmień hasło
                                    </button>
                                ...
                                <?php endif; ?>
                                <div class="text-center">
                                    <a class="small" href="/gr4/login">Przypomniało Ci się? </a>
                                </div>
                                <div class="text-center">
