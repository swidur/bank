                    ...
                    <div class="container col-xl-8 col-lg-10">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Zestawienie wszystkich produktów:</h6>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <!--region Card Body -->
                                    <div class="card-body">
                                        <div class="container px-0">
                                            ...
                                            <div class="container mb-4">
                                                ...
                                                <?php if (isset($this->checkingModelsArr) && $this->checkingModelsArr->countElements() > 0): ?>
                                                <div class="container">
                                                    <div class="row">
                                                    ...
                                                    <?php foreach ($this->checkingModelsArr->getElements() as $account): ?>
                                                        <div class="row">
                                            ...
                                            <div class="container mb-4">
                                                <div class="row">
                                                    <div class="col">
                                                        <h1 class="h5">Karty</h1>
                                                    </div>
                                                </div>
                                                <?php if (isset($this->cardModelsArr) && $this->cardModelsArr->countElements() > 0): ?>
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-xl-3 col-lg-3 col-sm-3"><span class="small">Nazwa</span>
                                                        </div>
                                                        <div class="col-xl-5 col-lg-5 col-sm-5"><span class="small">Konto połączone z kartą</span>
                                                        </div>
                                                        <div class="col-xl-2 col-lg-2 col-sm-2"><span class="small">Ważna do</span>
                                                        </div>
                                                        <div class="col-xl-1 col-lg-1 col-sm-1"><span class="small">Akcje</span>
                                                        </div>
                                                    </div>
                                                    <?php foreach ($this->cardModelsArr->getElements() as $card): ?>
                                                        <div class="row">
                                                            <div class="col-xl-3 col-lg-3 col-sm-3">
                                                                <a href="/gr4/dashboard/history?account=<?php ?>"
                                                                   class="text-primary">
                                                                    <?php echo $card->getCardName() ?>
                                                                </a>
                                                            </div>

                                                            <div class="col-xl-5 col-lg-5 col-sm-5">
                                                                <span class="text-dark">
                                                                    <?php echo $card->getAccountDisplayInfo() ?>
                                                                </span>
                                                            </div>

                                                            <div class="col-xl-2 col-lg-2 col-sm-2">
                                                                <span class="text-dark">
                                                                    <?php echo $card->getValidThru() ?>
                                                                </span>
                                                            </div>
                                            ...
                                            <!--                    endregion Cards Accounts-->

                                            <!--                    region Loans-->
                                            <div class="container mb-4">
                                                <div class="row">
                                                    <div class="col">
                                                        <h1 class="h5">Pożyczki konsumenckie</h1>
                                                    </div>
                                                    <div class="col">
                                                        <a href="" class="float-right mr-5 mt-1">Załóż konto <i
                                                                    class="fas fa-chevron-down ml-1"></i></a>
                                                ...
                                                <?php if (isset($this->consumerLoanModelsArr) && $this->consumerLoanModelsArr->countElements() > 0): ?>
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-xl-4 col-lg-4 col-sm-4"><span class="small">Nazwa</span>
                                                        </div>
                                                        <div class="col-xl-2 col-lg-2 col-sm-2"><span class="small">Kwota pożyczki</span>
                                                        </div>
                                                        <div class="col-xl-2 col-lg-2 col-sm-2"><span class="small">Ilość rat</span>
                                                        </div>
                                                        <div class="col-xl-2 col-lg-2 col-sm-2"><span class="small">Akcje</span>
                                                        </div>
                                                    </div>
                                                    <?php foreach ($this->consumerLoanModelsArr->getElements() as $loan): ?>
                                                        <div class="row">
                                                            <div class="col-xl-4 col-lg-4 col-sm-4">
                                                                <a href="/gr4/dashboard/history?account=<?php echo $loan->getLoanName() ?>"
                                                                   class="text-primary">
                                                                    <?php echo $loan->getLoanName() ?>
                                                                </a>
                                                            </div>

                                                            <div class="col-xl-2 col-lg-2 col-sm-2">
                                                                <span class="text-dark">
                                                                    <?php echo $loan->getAmount() ?>
                                                                </span>
                                                            </div>

                                                            <div class="col-xl-2 col-lg-2 col-sm-2">
                                                                <span class="text-dark">
                                                                    <?php echo $loan->getInstallments() ?>
                                                                </span>
                                                            </div>

                                                            <div class="col-xl-2 col-lg-2 col-sm-2">
                                                                <span class="text-dark">
                                                                    <?php echo $loan->getInterestRate() ?>
                                                                </span>
                                                            </div>
                                            ...
                                            <div class="container mb-4">
                                                <div class="row">
                                                    <div class="col">
                                                        <h1 class="h5">Kredyty hipoteczne</h1>
                                                    </div>
                                                    <div class="col">
                                                        <a href="" class="float-right mr-5 mt-1">Załóż konto <i
                                                                    class="fas fa-chevron-down ml-1"></i></a>
...
<script>
    sendDate.min = new Date().toISOString().split("T")[0];
</script>
<!--endregion-->
